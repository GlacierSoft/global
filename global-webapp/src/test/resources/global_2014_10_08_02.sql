...
CREATE TABLE `t_carrier_member` (
  ...
  `membe_typer` enum('individuality','enterprise','clique') default NULL,
  `status` enum('enable','disable') default NULL,
...
CREATE TABLE `t_carrier_member_token` (
  ...
  `stalt` varchar(64) default NULL,
  `traters_password` varchar(64) default NULL,
  `traters_stalt` varchar(64) default NULL,
  PRIMARY KEY  (`carrier_member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_shipper_member` (
  ...
  `registration_time` datetime default NULL,
  `last_login_time` datetime default NULL,
  `membe_typer` enum('individuality','enterprise') default NULL,
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('8b25651c2d896297530b64e4b80ec503', 'admin', '超级管理员', '5dc10e7826e648ec6f136974c38f81d0e5e1d0ae', 'e03b1b95ceff4db6', 'enable', 'admin', 'admin@glacier.cn', null, null, '2014-10-08 13:24:49', '127.0.0.1[本地]', '949', '8b25651c2d896297530b64e4b80ec503', '2014-02-27 02:58:02');
