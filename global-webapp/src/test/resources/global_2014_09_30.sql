...
INSERT INTO `t_loginlog` VALUES ('1bf23b11b830d2ec35ad0d6c0706b136', '8b25651c2d896297530b64e4b80ec503', '超级管理员', '2014-09-30 16:15:54', '127.0.0.1[本地]', null, null);
...
-- ----------------------------
INSERT INTO `t_operalog` VALUES ('0d3382c81b9272e8e1b5097ba1b0d24a', '导航信息', '导航树', '修改', '1', '[公司简介] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-10 16:12:14');
INSERT INTO `t_operalog` VALUES ('126243aeafd10b9802c5e386896cfa6c', '导航信息', '导航树', '修改', '1', '[公司简介] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-30 16:19:42');
...
INSERT INTO `t_operalog` VALUES ('31a67d7ed192c95409d464d3fecd38fc', '导航信息', '导航树', '修改', '1', '[联系我们] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-30 16:19:35');
INSERT INTO `t_operalog` VALUES ('331fd2feefe575c3002fc3d5d4dbcc95', '导航信息', '导航树', '增加', '1', '[公司地图] 导航信息已保存', 'com.glacier.frame.service.website.WebsiteNavService', 'addNav', 'NavTree_add', '超级管理员', '2014-09-30 16:17:45');
INSERT INTO `t_operalog` VALUES ('3c6aa7a4b6a70351cfb24c97b5e98145', '导航信息', '导航树', '修改', '1', '[首页] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-10 16:33:20');
INSERT INTO `t_operalog` VALUES ('3deeba57be1163031e5a38eaee00ea04', '下拉项管理', '下拉列表', '增加', '1', '[陆运新闻] 下拉项值信息已保存', 'com.glacier.frame.service.basicdatas.ParameterOptgroupValueService', 'addOptgroupValue', 'OptgroupValueList_add', '超级管理员', '2014-09-28 15:47:53');
INSERT INTO `t_operalog` VALUES ('4c85a07aaad8b8a6e2e92593466e1311', '下拉项管理', '下拉列表', '增加', '1', '[海运新闻] 下拉项值信息已保存', 'com.glacier.frame.service.basicdatas.ParameterOptgroupValueService', 'addOptgroupValue', 'OptgroupValueList_add', '超级管理员', '2014-09-28 15:49:00');
...
INSERT INTO `t_operalog` VALUES ('6d116251f99c753f9e01ccd90c9a7873', '新闻管理', '新闻列表', '增加', '1', '[sssssssssssssssss] 新闻信息已保存', 'com.glacier.frame.service.website.WebsiteNewsService', 'addNews', 'NewsList_add', '超级管理员', '2014-09-28 16:01:18');
INSERT INTO `t_operalog` VALUES ('732ade7e0e0ee74204de6d3ec2e61137', '下拉项管理', '下拉列表', '增加', '1', '[贸易新闻] 下拉项值信息已保存', 'com.glacier.frame.service.basicdatas.ParameterOptgroupValueService', 'addOptgroupValue', 'OptgroupValueList_add', '超级管理员', '2014-09-28 15:48:32');
INSERT INTO `t_operalog` VALUES ('7396f22b8cf4adb11a872810153a3342', '导航信息', '导航树', '增加', '1', '[其他业务] 导航信息已保存', 'com.glacier.frame.service.website.WebsiteNavService', 'addNav', 'NavTree_add', '超级管理员', '2014-09-30 16:18:26');
INSERT INTO `t_operalog` VALUES ('7862633d32ecf96aca84834f3a312d85', '下拉项管理', '下拉项树', '增加', '1', '[新闻管理] 下拉项信息已保存', 'com.glacier.frame.service.basicdatas.ParameterOptgroupService', 'addOptgroup', 'OptgroupTree_add', '超级管理员', '2014-09-28 15:44:53');
INSERT INTO `t_operalog` VALUES ('78d617a60cac215899158ba7696f1e51', '导航信息', '导航树', '修改', '1', '[我要登录] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-10 16:10:56');
INSERT INTO `t_operalog` VALUES ('7d0ae597afdf66bd142542cc3857fc26', '导航信息', '导航树', '修改', '1', '[首页] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-10 16:32:42');
INSERT INTO `t_operalog` VALUES ('860bb3d30f690c9082e55db5ebc1d1b6', '导航信息', '导航树', '修改', '1', '[招聘信息] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-10 16:12:42');
INSERT INTO `t_operalog` VALUES ('93a5b7d9e5e2669350848f9d17ac503c', '导航信息', '导航树', '修改', '1', '[其他业务] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-30 16:18:35');
INSERT INTO `t_operalog` VALUES ('946e55c7c852473fa313287a348c4999', '下拉项管理', '下拉列表', '增加', '1', '[空运新闻] 下拉项值信息已保存', 'com.glacier.frame.service.basicdatas.ParameterOptgroupValueService', 'addOptgroupValue', 'OptgroupValueList_add', '超级管理员', '2014-09-28 15:47:12');
INSERT INTO `t_operalog` VALUES ('94c326b66ec73147a7f6b10b80a340a7', '导航信息', '导航树', '修改', '1', '[联系我们] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-10 16:11:59');
INSERT INTO `t_operalog` VALUES ('9bd8ddabf2c964b73a51eec2d783a658', '导航信息', '导航树', '修改', '1', '[招聘信息] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-30 16:20:01');
...
INSERT INTO `t_operalog` VALUES ('b580ae03a9f9d804fca76c7072b9b8fa', '导航信息', '导航树', '增加', '1', '[网站公告] 导航信息已保存', 'com.glacier.frame.service.website.WebsiteNavService', 'addNav', 'NavTree_add', '超级管理员', '2014-09-28 16:22:09');
...
INSERT INTO `t_operalog` VALUES ('cbba8692bcecd46556de9bd37e0c4a6d', '下拉项管理', '下拉项树', '增加', '1', '[新闻类型] 下拉项信息已保存', 'com.glacier.frame.service.basicdatas.ParameterOptgroupService', 'addOptgroup', 'OptgroupTree_add', '超级管理员', '2014-09-28 15:45:44');
INSERT INTO `t_operalog` VALUES ('d216d77e11cbfa24c053b03ce44bedf8', '新闻管理', '新闻列表', '删除', '1', '成功删除了[ sssssssssssssssss ]新闻', 'com.glacier.frame.service.website.WebsiteNewsService', 'delNews', 'NewsList_del', '超级管理员', '2014-09-28 16:59:08');
INSERT INTO `t_operalog` VALUES ('d8670103a24fd8bb1a573b62b6d93ace', '导航信息', '导航树', '修改', '1', '[我要注册] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-10 16:11:15');
INSERT INTO `t_operalog` VALUES ('db0accb90d0847bca4d35f8350d5413f', '下拉项管理', '下拉项树', '修改', '1', '[新闻类型] 下拉项信息已修改', 'com.glacier.frame.service.basicdatas.ParameterOptgroupService', 'editOptgroup', 'OptgroupTree_edit', '超级管理员', '2014-09-28 15:56:47');
INSERT INTO `t_operalog` VALUES ('ddd66b531e8a65dc3106e9ca2253e73c', '导航信息', '导航树', '修改', '1', '[我要登录] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-30 16:19:24');
...
INSERT INTO `t_operalog` VALUES ('e8470e5a0ff9c701e17fe3d0b638b449', '导航信息', '导航树', '修改', '1', '[我要注册] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-30 16:19:28');
...
INSERT INTO `t_operalog` VALUES ('f11eb0f7249df0cf5d9657c850bc67c0', '导航信息', '导航树', '修改', '1', '[公司地图] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-30 16:20:06');
INSERT INTO `t_operalog` VALUES ('fe471407b0a76cd3801a7fc206d6bf65', '导航信息', '导航树', '修改', '1', '[网站公告] 导航信息已修改', 'com.glacier.frame.service.website.WebsiteNavService', 'editNav', 'NavTree_edit', '超级管理员', '2014-09-30 16:19:52');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('8b25651c2d896297530b64e4b80ec503', 'admin', '超级管理员', '5dc10e7826e648ec6f136974c38f81d0e5e1d0ae', 'e03b1b95ceff4db6', 'enable', 'admin', 'admin@glacier.cn', null, null, '2014-09-30 16:15:54', '127.0.0.1[本地]', '946', '8b25651c2d896297530b64e4b80ec503', '2014-02-27 02:58:02');
...
-- ----------------------------
INSERT INTO `t_website_nav` VALUES ('0e68817baeba1109fbcfd53c837dbc66', '533321196059fa5805661651134a58fe', '联系我们', '/contactUs.htm', 'enable', '1', '', '8b25651c2d896297530b64e4b80ec503', '2014-02-14 13:49:51', '8b25651c2d896297530b64e4b80ec503', '2014-09-30 16:19:35');
INSERT INTO `t_website_nav` VALUES ('133ccad08d70daf73b77fb8fb1bcee0c', null, '首页', '/index.htm', 'enable', '1', '', '8b25651c2d896297530b64e4b80ec503', '2014-02-14 13:43:48', '8b25651c2d896297530b64e4b80ec503', '2014-09-10 16:33:20');
INSERT INTO `t_website_nav` VALUES ('13ec2de80e1d0670157988b215adc3fb', '533321196059fa5805661651134a58fe', '其他业务', '/others/others.htm', 'enable', '4', '', '8b25651c2d896297530b64e4b80ec503', '2014-09-30 16:18:26', '8b25651c2d896297530b64e4b80ec503', '2014-09-30 16:18:35');
INSERT INTO `t_website_nav` VALUES ('1d33d5a8b6d5a2fe73eb78b7c8439624', '533321196059fa5805661651134a58fe', '公司简介', '/aboutUs.htm', 'enable', '2', '', '8b25651c2d896297530b64e4b80ec503', '2014-02-14 13:49:36', '8b25651c2d896297530b64e4b80ec503', '2014-09-30 16:19:42');
INSERT INTO `t_website_nav` VALUES ('28cd4d77a1b0bd7caa226dc4a0361d38', '533321196059fa5805661651134a58fe', '网站公告', '/announcement/announcement.htm?&p=1', 'enable', '3', '', '8b25651c2d896297530b64e4b80ec503', '2014-09-28 16:22:09', '8b25651c2d896297530b64e4b80ec503', '2014-09-30 16:19:52');
INSERT INTO `t_website_nav` VALUES ('42bdcfbb624c975eea75c7d06b943853', '533321196059fa5805661651134a58fe', '招聘信息', '/hiring/hiring.htm?&p=1', 'enable', '5', '', '8b25651c2d896297530b64e4b80ec503', '2014-02-14 13:50:02', '8b25651c2d896297530b64e4b80ec503', '2014-09-30 16:20:01');
...
INSERT INTO `t_website_nav` VALUES ('5053df8429b37b4f60f50052be91a9bd', '533321196059fa5805661651134a58fe', '公司地图', '/others/otherAddress.htm', 'enable', '6', '', '8b25651c2d896297530b64e4b80ec503', '2014-09-30 16:17:45', '8b25651c2d896297530b64e4b80ec503', '2014-09-30 16:20:06');
...
INSERT INTO `t_website_nav` VALUES ('5f76cc51c5d787932f09c4425350a79a', '4edb2ec67480c21811ddb0b16f0e5218', '我要登录', '/login.htm', 'enable', '1', '', '8b25651c2d896297530b64e4b80ec503', '2014-02-14 13:48:46', '8b25651c2d896297530b64e4b80ec503', '2014-09-30 16:19:24');
...
INSERT INTO `t_website_nav` VALUES ('b45b9148c7cd2b5f7ec1d53a3d6ec99f', '4edb2ec67480c21811ddb0b16f0e5218', '我要注册', '/intoregister.htm', 'enable', '2', '', '8b25651c2d896297530b64e4b80ec503', '2014-02-14 13:48:59', '8b25651c2d896297530b64e4b80ec503', '2014-09-30 16:19:28');
