...
INSERT INTO `t_action` VALUES ('3ff5ec10d2406bd4dd4566a0eeca09f3', '71bb2fbcc0917bb080dc4ad897f63317', '700f1dcbd684c430008a23c708b5d42e', '打印', 'print', 'icon-standard-drive-magnify', 'Button', 'enable', 'glacier.member_mgr.contract_mgr.contract.printContract();', '1', '');
...
INSERT INTO `t_action` VALUES ('6c69cb1e61e061b4bfc5da370f279afd', 'bcd84260e047d3b1b92944abc7a33d82', '25a168f5c20cbd169b5b63d43e495c41', '启用\\禁用', 'edit', 'icon-standard-key', 'Button', 'enable', 'glacier.member_mgr.contractManager_mgr.contractManager.editContractorManager();', '4', '');
...
INSERT INTO `t_action` VALUES ('7168076078afbfbbf7002ccce1c43fe9', 'bcd84260e047d3b1b92944abc7a33d82', '25a168f5c20cbd169b5b63d43e495c41', '添加', 'add', 'icon-standard-key-add', 'Button', 'enable', 'glacier.member_mgr.contractManager_mgr.contractManager.addContractorManager();', '1', '');
...
INSERT INTO `t_action` VALUES ('78a67d022d221e66c0416df9dc69c600', 'bcd84260e047d3b1b92944abc7a33d82', '25a168f5c20cbd169b5b63d43e495c41', '删除', 'del', 'icon-standard-key-delete', 'Button', 'enable', 'glacier.member_mgr.contractManager_mgr.contractManager.delContractorManager();', '3', '');
...
INSERT INTO `t_action` VALUES ('bc314cb5d99ba206aa34d1cfe84ece81', 'bcd84260e047d3b1b92944abc7a33d82', '25a168f5c20cbd169b5b63d43e495c41', '修改', 'update', 'icon-standard-key-go', 'Button', 'enable', 'glacier.member_mgr.contractManager_mgr.contractManager.updateContractorManager();', '2', '');
...
INSERT INTO `t_authority` VALUES ('c87dd7161dbf8777c41b8cbfaa985db4', '71bb2fbcc0917bb080dc4ad897f63317', 'ContractList_print');
...
INSERT INTO `t_authority` VALUES ('c87dd7161dbf8777c41b8cbfaa985db4', 'bcd84260e047d3b1b92944abc7a33d82', 'ContractManagerList_add,ContractManagerList_update,ContractManagerList_del,ContractManagerList_edit');
...
INSERT INTO `t_loginlog` VALUES ('4f5c5fcb9631c03ef378e813d6a32cf5', '8b25651c2d896297530b64e4b80ec503', '超级管理员', '2014-10-09 09:21:49', '127.0.0.1[本地]', null, null);
INSERT INTO `t_loginlog` VALUES ('507b19096c95ac718b9bf64f9f3559ca', '8b25651c2d896297530b64e4b80ec503', '超级管理员', '2014-10-09 09:17:15', '127.0.0.1[本地]', null, null);
...
-- ----------------------------
INSERT INTO `t_member_integral` VALUES ('6cd8439abff3b4a83c4ff133feef25d4', 'f03baec448848d2375b92f1f15ddaff1', 'login', 'increase', '2', '登录获得2积分', '8b25651c2d896297530b64e4b80ec503', '2014-10-08 08:58:22', '8b25651c2d896297530b64e4b80ec503', '2014-10-08 08:58:22');
...
INSERT INTO `t_menu` VALUES ('71bb2fbcc0917bb080dc4ad897f63317', 'fefe8e9ee335dadbace082923415e023', 'contract', '会员合同记录', 'icon-standard-door-in', '/do/contract/index.htm', '12', '');
...
INSERT INTO `t_menu` VALUES ('bcd84260e047d3b1b92944abc7a33d82', 'fefe8e9ee335dadbace082923415e023', 'constractManager', '会员合同管理', 'icon-standard-folder-explore', '/do/contractManager/index.htm', '11', '');
...
INSERT INTO `t_operalog` VALUES ('0b35ebf50f61369d8845699a3205e7d0', '资源管理', '菜单树', '修改', '1', '[会员合同管理] 菜单信息已保存', 'com.glacier.frame.service.system.MenuService', 'editMenu', 'MenuTree_edit', '超级管理员', '2014-10-09 09:18:22');
INSERT INTO `t_operalog` VALUES ('0d0a9d23a314145732cbd9ce527e8a1b', '资源管理', '操作列表', '增加', '1', '[添加] 操作信息已保存', 'com.glacier.frame.service.system.ActionService', 'addAction', 'ActionList_add', '超级管理员', '2014-10-09 09:08:21');
INSERT INTO `t_operalog` VALUES ('0f086529251976b45b40d782523fb414', '资源管理', '操作列表', '编辑', '1', '[添加] 操作信息已保存', 'com.glacier.frame.service.system.ActionService', 'editAction', 'ActionList_edit', '超级管理员', '2014-10-09 09:27:09');
INSERT INTO `t_operalog` VALUES ('1604ec2f66ec3893f1f8e151a3a7578a', '资源管理', '菜单树', '修改', '1', '[会员合同管理] 菜单信息已保存', 'com.glacier.frame.service.system.MenuService', 'editMenu', 'MenuTree_edit', '超级管理员', '2014-10-09 09:18:12');
INSERT INTO `t_operalog` VALUES ('23f077383e36cfdfe7749721008f1de6', '角色管理', '角色列表', '授权', '1', '权限信息已保存', 'com.glacier.frame.service.system.AuthorityService', 'saveRoleAuths', 'RoleList_auth', '超级管理员', '2014-10-09 09:19:36');
INSERT INTO `t_operalog` VALUES ('2709419b4121b004e5e40044bba2fcbc', '资源管理', '菜单树', '增加', '1', '[会员合合同管理] 菜单信息已保存', 'com.glacier.frame.service.system.MenuService', 'addMenu', 'MenuTree_add', '超级管理员', '2014-10-09 09:03:37');
...
INSERT INTO `t_operalog` VALUES ('3215f2f23298e561b7805ebb296a3a65', '角色管理', '角色列表', '授权', '1', '权限信息已保存', 'com.glacier.frame.service.system.AuthorityService', 'saveRoleAuths', 'RoleList_auth', '超级管理员', '2014-10-09 09:27:54');
INSERT INTO `t_operalog` VALUES ('3232ae766ab8f72f8a85c61516a86822', '资源管理', '菜单树', '修改', '1', '[会员合同记录] 菜单信息已保存', 'com.glacier.frame.service.system.MenuService', 'editMenu', 'MenuTree_edit', '超级管理员', '2014-10-09 09:05:59');
INSERT INTO `t_operalog` VALUES ('3265d27af9e6e7aa90ff4ecf4a4b5054', '资源管理', '菜单树', '修改', '1', '[会员合同记录] 菜单信息已保存', 'com.glacier.frame.service.system.MenuService', 'editMenu', 'MenuTree_edit', '超级管理员', '2014-10-09 09:14:25');
INSERT INTO `t_operalog` VALUES ('429bd9c5109b5546e31b2a4370a843d2', '资源管理', '操作列表', '增加', '1', '[删除] 操作信息已保存', 'com.glacier.frame.service.system.ActionService', 'addAction', 'ActionList_add', '超级管理员', '2014-10-09 09:09:25');
INSERT INTO `t_operalog` VALUES ('4b51c58dd026f9e39b5e8f5c562a6cb0', '资源管理', '面板列表', '修改', '1', '[会员合同管理列表] 面板信息已保存', 'com.glacier.frame.service.system.PanelService', 'editPanel', 'PanelList_edit', '超级管理员', '2014-10-09 09:16:43');
...
INSERT INTO `t_operalog` VALUES ('6ec235c449ec1ff7d0c67c962d9162f6', '资源管理', '菜单树', '修改', '1', '[会员合同记录] 菜单信息已保存', 'com.glacier.frame.service.system.MenuService', 'editMenu', 'MenuTree_edit', '超级管理员', '2014-10-09 09:18:27');
INSERT INTO `t_operalog` VALUES ('70349ac3af39524b9c2d9585cf7530d4', '角色管理', '角色列表', '授权', '1', '权限信息已保存', 'com.glacier.frame.service.system.AuthorityService', 'saveRoleAuths', 'RoleList_auth', '超级管理员', '2014-10-09 09:23:34');
INSERT INTO `t_operalog` VALUES ('70b3dd91c46a922abbb35d4589d11ed6', '资源管理', '面板列表', '修改', '1', '[会员合同管理列表] 面板信息已保存', 'com.glacier.frame.service.system.PanelService', 'editPanel', 'PanelList_edit', '超级管理员', '2014-10-09 09:26:55');
INSERT INTO `t_operalog` VALUES ('71c5a43013803f344503096a243b928a', '角色管理', '角色列表', '授权', '1', '权限信息已保存', 'com.glacier.frame.service.system.AuthorityService', 'saveRoleAuths', 'RoleList_auth', '超级管理员', '2014-10-09 09:23:59');
INSERT INTO `t_operalog` VALUES ('8bf5900d0964d3b98941678aa0dad9c6', '资源管理', '菜单树', '增加', '1', '[会员合同管理] 菜单信息已保存', 'com.glacier.frame.service.system.MenuService', 'addMenu', 'MenuTree_add', '超级管理员', '2014-10-09 09:06:59');
INSERT INTO `t_operalog` VALUES ('a3002605adb47863c466447ed9d7d63e', '资源管理', '操作列表', '增加', '1', '[打印] 操作信息已保存', 'com.glacier.frame.service.system.ActionService', 'addAction', 'ActionList_add', '超级管理员', '2014-10-09 09:05:37');
INSERT INTO `t_operalog` VALUES ('ab12162432087abeffc0e4a59d961c9c', '角色管理', '角色列表', '授权', '1', '权限信息已保存', 'com.glacier.frame.service.system.AuthorityService', 'saveRoleAuths', 'RoleList_auth', '超级管理员', '2014-10-09 09:18:57');
INSERT INTO `t_operalog` VALUES ('b1c937b21775dd02b96f41b8b5897294', '资源管理', '菜单树', '修改', '1', '[会员合同记录] 菜单信息已保存', 'com.glacier.frame.service.system.MenuService', 'editMenu', 'MenuTree_edit', '超级管理员', '2014-10-09 09:12:44');
INSERT INTO `t_operalog` VALUES ('b4964fde7f369f4d734833c67880fc12', '角色管理', '角色列表', '授权', '1', '权限信息已保存', 'com.glacier.frame.service.system.AuthorityService', 'saveRoleAuths', 'RoleList_auth', '超级管理员', '2014-10-09 09:13:00');
INSERT INTO `t_operalog` VALUES ('bad10d22d02ea75b92816f61e91d78bb', '资源管理', '面板列表', '增加', '1', '[会员合同管理列表] 面板信息已保存', 'com.glacier.frame.service.system.PanelService', 'addPanel', 'PanelList_add', '超级管理员', '2014-10-09 09:07:36');
...
INSERT INTO `t_operalog` VALUES ('cd3b3b3979b122c277a64cda4a3dfb52', '资源管理', '操作列表', '增加', '1', '[修改] 操作信息已保存', 'com.glacier.frame.service.system.ActionService', 'addAction', 'ActionList_add', '超级管理员', '2014-10-09 09:08:55');
INSERT INTO `t_operalog` VALUES ('d0f294b3fd1d843368d57296b8970d09', '资源管理', '面板列表', '修改', '1', '[会员合同管理列表] 面板信息已保存', 'com.glacier.frame.service.system.PanelService', 'editPanel', 'PanelList_edit', '超级管理员', '2014-10-09 09:25:12');
INSERT INTO `t_operalog` VALUES ('e072becc3de8729a3c5c12d7bebcab5d', '角色管理', '角色列表', '授权', '1', '权限信息已保存', 'com.glacier.frame.service.system.AuthorityService', 'saveRoleAuths', 'RoleList_auth', '超级管理员', '2014-10-09 09:17:37');
INSERT INTO `t_operalog` VALUES ('e1acb98b67616fe540d6b76b33be8d7e', '资源管理', '菜单树', '修改', '1', '[会员合同记录] 菜单信息已保存', 'com.glacier.frame.service.system.MenuService', 'editMenu', 'MenuTree_edit', '超级管理员', '2014-10-09 09:18:03');
INSERT INTO `t_operalog` VALUES ('e1b4d43a7334c075d89454bf00be1149', '资源管理', '操作列表', '增加', '1', '[启用\\禁用] 操作信息已保存', 'com.glacier.frame.service.system.ActionService', 'addAction', 'ActionList_add', '超级管理员', '2014-10-09 09:10:05');
INSERT INTO `t_operalog` VALUES ('e7df2031dbdf93682223d635721f9c65', '资源管理', '面板列表', '修改', '1', '[会员合同列表] 面板信息已保存', 'com.glacier.frame.service.system.PanelService', 'editPanel', 'PanelList_edit', '超级管理员', '2014-10-09 09:15:32');
INSERT INTO `t_operalog` VALUES ('e9c32175a6f96f44fde91ade2998c4f1', '角色管理', '角色列表', '授权', '1', '权限信息已保存', 'com.glacier.frame.service.system.AuthorityService', 'saveRoleAuths', 'RoleList_auth', '超级管理员', '2014-10-09 09:10:19');
INSERT INTO `t_operalog` VALUES ('f1391c81d9b211556da2b68dc8ed7755', '资源管理', '面板列表', '增加', '1', '[会员合同列表] 面板信息已保存', 'com.glacier.frame.service.system.PanelService', 'addPanel', 'PanelList_add', '超级管理员', '2014-10-09 09:04:49');
INSERT INTO `t_operalog` VALUES ('f37bf2e8c9a97bf4b8790058b4f417b4', '资源管理', '面板列表', '修改', '1', '[会员合同管理列表] 面板信息已保存', 'com.glacier.frame.service.system.PanelService', 'editPanel', 'PanelList_edit', '超级管理员', '2014-10-09 09:21:10');
...
INSERT INTO `t_panel` VALUES ('25a168f5c20cbd169b5b63d43e495c41', 'bcd84260e047d3b1b92944abc7a33d82', '会员合同管理列表', 'ContractManagerList', '1');
...
INSERT INTO `t_panel` VALUES ('700f1dcbd684c430008a23c708b5d42e', '71bb2fbcc0917bb080dc4ad897f63317', '会员合同列表', 'ContractList', '1');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('8b25651c2d896297530b64e4b80ec503', 'admin', '超级管理员', '5dc10e7826e648ec6f136974c38f81d0e5e1d0ae', 'e03b1b95ceff4db6', 'enable', 'admin', 'admin@glacier.cn', null, null, '2014-10-09 09:21:49', '127.0.0.1[本地]', '959', '8b25651c2d896297530b64e4b80ec503', '2014-02-27 02:58:02');
